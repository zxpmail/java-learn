...
public class MinioUtils {
    ...
    public List<Fileinfo> listObjects(String bucketName) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            items.add(new Fileinfo(item.objectName(),item.isDir(),item.size()));
        }
    ...
    public String getObjectUrl(String fileName){
        // 查看文件地址
        GetPresignedObjectUrlArgs build = GetPresignedObjectUrlArgs.builder().bucket(minioProp.getBucketName()).object(fileName).method(Method.GET).build();
        try {
